    ...
    <div className="relative bg-white rounded-lg p-3 shadow-sm">
      ...
      <ResponsiveContainer width="100%" height={180}>
        <LineChart data={chartData} margin={{ top: 4, right: 16, bottom: 24, left: 32 }}>
          ...
          <Line type="monotone" dataKey="jointX" name="Joint X" stroke="#f97316" dot={showDots ? { r: 4, fill: '#f97316', strokeWidth: 0 } : false} strokeWidth={1.5} isAnimationActive={false} />
          <Line type="monotone" dataKey="jointY" name="Joint Y" stroke="#3b82f6" dot={showDots ? { r: 4, fill: '#3b82f6', strokeWidth: 0 } : false} strokeWidth={1.5} isAnimationActive={false} />
