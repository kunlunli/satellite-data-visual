    ...
    <div className="bg-white rounded-lg p-3 shadow-sm">
      ...
      <ResponsiveContainer width="100%" height={height}>
        <LineChart data={chartData} margin={{ top: 4, right: 16, bottom: 24, left: 32 }}>
          ...
          <Line type="monotone" dataKey="cur" name="Current EL" stroke="#3b82f6" dot={false} strokeWidth={1.5} isAnimationActive={false} />
          <Line type="monotone" dataKey="target" name="Target EL" stroke="#f97316" dot={false} strokeWidth={1.5} isAnimationActive={false} />
