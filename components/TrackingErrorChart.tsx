...
export default function TrackingErrorChart({ data, currentIndex }: Props) {
      ...
      <ResponsiveContainer width="100%" height={180}>
        <LineChart data={chartData} margin={{ top: 4, right: 16, bottom: 24, left: 32 }}>
          ...
          <XAxis
            ...
            tick={{ fontSize: 9 }}
            label={{ value: 'Flight time', position: 'insideBottom', offset: -12, fontSize: 11 }}
          />
          <YAxis
            domain={['auto', 'auto']}
            tick={{ fontSize: 10 }}
          ...
          <Line type="monotone" dataKey="paeX" name="PAE X" stroke="#ef4444" dot={false} strokeWidth={1.5} isAnimationActive={false} />
          <Line type="monotone" dataKey="paeY" name="PAE Y" stroke="#06b6d4" dot={false} strokeWidth={1.5} isAnimationActive={false} />
